...
def parse_arguments():
    ...
    parser.add_argument(
        "--model", type=str, default="llama-13b", choices=["gpt3", "gpt3-medium", "gpt3-large", "gpt3-xl", "llama-13b", "llama-7b"], help="model used for decoding. Note that 'gpt3' are the smallest models."
    )
    ...
    parser.add_argument(
        "--use_lora", type=bool, default=False, help="whether use lora"
    )
    
    parser.add_argument(
        "--model_path", type=str, default="", help="model directory"
    )
    
    parser.add_argument(
        "--lora_path", type=str, default="", help="lora directory"
    )
