...
#SBATCH --output=halueval_llama_13b_with_qa_dpo_istj.out
...
python evaluate_with_vllm.py --task qa --model llama_13b_dpo_istj --model_path /data/datasets/models/huggingface/meta-llama/Llama-2-13b-chat-hf/ --lora True --lora_type dpo --lora_path /data/user_data/wenkail/llama_finetune_13b_persona/dpo_checkpoint/lora/istj/checkpoint-12000
