...
CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7,8 WANDB_PROJECT=llm_personality WANDB_ENTITY=kyle_organization llamafactory-cli train src/llama3_lora_dpo_ds3.yaml
