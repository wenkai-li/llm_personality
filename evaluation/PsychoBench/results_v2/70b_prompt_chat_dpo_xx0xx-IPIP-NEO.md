...
- **Two Sample T-test (Welch's T-Test):**
	...
	t-value = 3.4452	($df$ = 4.0)

	p-value = 0.0259	(two-tailed test)

	Null hypothesis $H_0$ ($µ_1$ = $µ_2$): 	Since p-value (0.0259) > α (0.01), $H_0$ cannot be rejected.
...
- **F-Test:**
	...
	f-value = 120.1144	($df_1$ = 619149, $df_2$ = 4)
...
- **Two Sample T-test (Welch's T-Test):**
	...
	t-value = -3.7113	($df$ = 4.0)

	p-value = 0.0206	(two-tailed test)

	Null hypothesis $H_0$ ($µ_1$ = $µ_2$): 	Since p-value (0.0206) > α (0.01), $H_0$ cannot be rejected.
