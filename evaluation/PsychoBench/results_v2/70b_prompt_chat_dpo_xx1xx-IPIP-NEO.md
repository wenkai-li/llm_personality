...
| :---: | :---: | :---: |
| Extraversion | 2.5 $\pm$ 0.0 | 3.4 $\pm$ 1.0 | 
...
- **Two Sample T-test (Welch's T-Test):**
	...
	t-value = -0.8622	($df$ = 4.0)

	p-value = 0.4371	(two-tailed test)

	Null hypothesis $H_0$ ($µ_1$ = $µ_2$): 	Since p-value (0.4371) > α (0.01), $H_0$ cannot be rejected.
