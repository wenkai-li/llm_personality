...
| :---: | :---: | :---: |
| Extraversion | 3.7 $\pm$ 0.0 | 3.4 $\pm$ 1.0 | 
...
- **Two Sample T-test (Welch's T-Test):**
	...
	t-value = 1.6646	($df$ = 4.0)

	p-value = 0.1710	(two-tailed test)

	Null hypothesis $H_0$ ($µ_1$ = $µ_2$): 	Since p-value (0.1710) > α (0.01), $H_0$ cannot be rejected.
...
- **Two Sample T-test (Welch's T-Test):**
	...
	t-value = 5.3265	($df$ = 4.1)

	p-value = 0.0057	(two-tailed test)

	Null hypothesis $H_0$ ($µ_1$ = $µ_2$): Since p-value (0.0057) < α (0.01), $H_0$ is rejected.
...
- **F-Test:**
	...
	f-value = 323.5967	($df_1$ = 619149, $df_2$ = 4)
