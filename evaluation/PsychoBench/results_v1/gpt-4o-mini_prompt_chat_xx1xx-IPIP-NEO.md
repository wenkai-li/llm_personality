...
| :---: | :---: | :---: |
| Extraversion | 3.7 $\pm$ 0.1 | 3.4 $\pm$ 1.0 | 
...
- **Two Sample T-test (Welch's T-Test):**
	...
	t-value = 3.6736	($df$ = 4.0)

	p-value = 0.0212	(two-tailed test)

	Null hypothesis $H_0$ ($µ_1$ = $µ_2$): 	Since p-value (0.0212) > α (0.01), $H_0$ cannot be rejected.
