...
- **Two Sample T-test (Welch's T-Test):**
	...
	t-value = 6.9216	($df$ = 4.2)

	p-value = 0.0019	(two-tailed test)

	Null hypothesis $H_0$ ($µ_1$ = $µ_2$): Since p-value (0.0019) < α (0.01), $H_0$ is rejected.
