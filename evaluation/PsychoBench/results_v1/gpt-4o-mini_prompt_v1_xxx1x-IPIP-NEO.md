...
- **Two Sample T-test (Welch's T-Test):**
	...
	t-value = 4.2168	($df$ = 4.0)

	p-value = 0.0134	(two-tailed test)

	Null hypothesis $H_0$ ($µ_1$ = $µ_2$): 	Since p-value (0.0134) > α (0.01), $H_0$ cannot be rejected.
...
- **F-Test:**
	...
	f-value = 150.5101	($df_1$ = 619149, $df_2$ = 4)
...
- **Two Sample T-test (Welch's T-Test):**
	...
	t-value = 6.5091	($df$ = 4.0)

	p-value = 0.0029	(two-tailed test)

	Null hypothesis $H_0$ ($µ_1$ = $µ_2$): Since p-value (0.0029) < α (0.01), $H_0$ is rejected.
