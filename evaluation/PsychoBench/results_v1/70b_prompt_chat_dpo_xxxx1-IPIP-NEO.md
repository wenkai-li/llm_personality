...
- **F-Test:**
	...
	f-value = 352.5119	($df_1$ = 619149, $df_2$ = 4)
...
- **Two Sample T-test (Welch's T-Test):**
	...
	t-value = 5.8732	($df$ = 4.0)

	p-value = 0.0041	(two-tailed test)

	Null hypothesis $H_0$ ($µ_1$ = $µ_2$): Since p-value (0.0041) < α (0.01), $H_0$ is rejected.
