...
- **F-Test:**
	...
	f-value = 91.0544	($df_1$ = 619149, $df_2$ = 4)
...
- **Two Sample T-test (Welch's T-Test):**
	...
	t-value = 1.6159	($df$ = 4.0)

	p-value = 0.1813	(two-tailed test)

	Null hypothesis $H_0$ ($µ_1$ = $µ_2$): 	Since p-value (0.1813) > α (0.01), $H_0$ cannot be rejected.
...
- **Two Sample T-test (Welch's T-Test):**
	...
	t-value = 2.9908	($df$ = 4.0)

	p-value = 0.0397	(two-tailed test)

	Null hypothesis $H_0$ ($µ_1$ = $µ_2$): 	Since p-value (0.0397) > α (0.01), $H_0$ cannot be rejected.
