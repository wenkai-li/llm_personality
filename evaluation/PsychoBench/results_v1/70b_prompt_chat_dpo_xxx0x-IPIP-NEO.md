...
| Neuroticism | 2.0 $\pm$ 0.1 | 2.8 $\pm$ 1.0 | 
...
- **Two Sample T-test (Welch's T-Test):**
	...
	t-value = 2.7704	($df$ = 4.0)

	p-value = 0.0499	(two-tailed test)

	Null hypothesis $H_0$ ($µ_1$ = $µ_2$): 	Since p-value (0.0499) > α (0.01), $H_0$ cannot be rejected.
