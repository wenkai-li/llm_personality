...
- **Two Sample T-test (Welch's T-Test):**
	...
	t-value = 3.7295	($df$ = 4.1)

	p-value = 0.0198	(two-tailed test)

	Null hypothesis $H_0$ ($µ_1$ = $µ_2$): 	Since p-value (0.0198) > α (0.01), $H_0$ cannot be rejected.
...
- **Two Sample T-test (Welch's T-Test):**
	...
	t-value = 4.0150	($df$ = 4.0)

	p-value = 0.0156	(two-tailed test)

	Null hypothesis $H_0$ ($µ_1$ = $µ_2$): 	Since p-value (0.0156) > α (0.01), $H_0$ cannot be rejected.
...
- **F-Test:**
	...
	f-value = 117.6715	($df_1$ = 619149, $df_2$ = 4)
...
- **Two Sample T-test (Welch's T-Test):**
	...
	t-value = 7.0904	($df$ = 4.0)

	p-value = 0.0021	(two-tailed test)

	Null hypothesis $H_0$ ($µ_1$ = $µ_2$): Since p-value (0.0021) < α (0.01), $H_0$ is rejected.
