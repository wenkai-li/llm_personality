...
huggingface_token = os.environ.get('HUGGING_FACE_ACCESS_TOKEN')
# ===================== classes of model ===================== #
...
class PSYCHGEN(nn.Module):
    ...
    def __init__(self, model_name_or_path, latent_size):
        ...
        self.model_config = AutoConfig.from_pretrained(model_name_or_path, cache_dir = None, use_auth_token=huggingface_token)
    ...
    def initialize_model(self, args):
        ...
        self.decoder = AutoModelForCausalLM.from_pretrained(decoder_path, from_tf=bool('.ckpt' in decoder_path), config=self.model_config, use_auth_token=huggingface_token)
        self.tokenizer = AutoTokenizer.from_pretrained(tokenizer_path, do_lower_case=args.do_lower_case, add_prefix_space=True, use_auth_token=huggingface_token)
    ...
    def from_checkpoint(self, args, output_dir):
        ...
        self.decoder = AutoModelForCausalLM.from_pretrained(decoder_path, from_tf=bool('.ckpt' in decoder_path), config=self.model_config, ignore_mismatched_sizes = False, use_auth_token=huggingface_token)
        self.tokenizer = AutoTokenizer.from_pretrained(tokenizer_path, do_lower_case=args.do_lower_case, use_auth_token=huggingface_token)
