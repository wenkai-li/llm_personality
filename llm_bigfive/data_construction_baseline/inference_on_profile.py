...
out_f = open(f'/home/jiaruil5/personality/llm_personality/llm_bigfive/data_construction_baseline/classifier_on_profile/classifier_data_{trait_trait}.json', 'w')
...
# df_1 = pd.read_json("/data/user_data/wenkail/llm_personality/align/data_sft/train.json")
# df_1 = df_1.sample(n=1000, random_state=42)
# df = pd.DataFrame()
# df['message'] = df_1['output']
# labels = [[],[],[],[],[]]
# for idx, row in df_1.iterrows():
#     traits = ['o', 'c', 'e', 'a', 'n']
#     traits_full = ['Openness', 'Conscientiousness', 'Extraversion', 'Agreeableness', 'Neuroticism']
#     true_i = None
#     for i, (trait, trait_full) in enumerate(zip(traits, traits_full)):
#         if trait_full in row['instruction']:
#             true_i = i
#             if '- high' in row['instruction']:
#                 labels[i].append(1)
#             elif '- low' in row['instruction']:
#                 labels[i].append(0)
#             break
#     for i in range(5):
#         if i != true_i:
...
#     dataset.save_to_disk(f'/home/jiaruil5/personality/llm_personality/llm_bigfive/data_construction_baseline/classifier_on_profile/classifier_data_{i}')
# exit(0)

## second run
test_dataset = load_from_disk(f'/home/jiaruil5/personality/llm_personality/llm_bigfive/data_construction_baseline/classifier_on_profile/classifier_data_{trait_trait}')#.select(range(100))
...
data = json.load(open(f'/home/jiaruil5/personality/llm_personality/llm_bigfive/data_construction_baseline/classifier_on_profile/classifier_data_{trait_trait}.json', 'r'))
