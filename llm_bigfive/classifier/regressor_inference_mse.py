...
out_f = open('/home/jiaruil5/personality/llm_personality/llm_bigfive/classifier/results/mse_checkpoint_final_train.json', 'w')

test_dataset = load_from_disk('/data/user_data/wenkail/llm_personality/data_mse/train_psychgen')#.select(range(100))
...
data = json.load(open('/home/jiaruil5/personality/llm_personality/llm_bigfive/classifier/results/mse_checkpoint_final_train.json', 'r'))
