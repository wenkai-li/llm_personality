...
out_f = open(f'/home/jiaruil5/personality/llm_personality/llm_bigfive/classifier/results_baselines_big5chat_expert/generator_predictions_{trait}_test.json', 'w')

## first run
# from utils import preprocess_function_with_tokenizer
# df = pd.read_csv(f'/home/jiaruil5/personality/llm_personality/llm_bigfive/classifier/results_baselines_big5chat_expert/generator_predictions_{trait}.csv')
...
# dataset.save_to_disk(f'/home/jiaruil5/personality/llm_personality/llm_bigfive/classifier/results_baselines_big5chat_expert/generator_predictions_{trait}')
# exit(0)

## second run
test_dataset = load_from_disk(f'/home/jiaruil5/personality/llm_personality/llm_bigfive/classifier/results_baselines_big5chat_expert/generator_predictions_{trait}')
...
data = json.load(open(f'/home/jiaruil5/personality/llm_personality/llm_bigfive/classifier/results_baselines_big5chat_expert/generator_predictions_{trait}_test.json', 'r'))
