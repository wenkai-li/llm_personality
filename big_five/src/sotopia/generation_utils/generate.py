...
from models.config import get_model_name, get_model_config
...
async def agenerate_env_profile(
    ...
    return await agenerate(
        model_name=model_name,
        template="""Please generate a scenario and goals based on the examples below as well as the inspirational prompt, when creating the goals, try to find one point that both sides may not agree upon initially and need to collaboratively resolve it.
        Examples:
        {examples}
