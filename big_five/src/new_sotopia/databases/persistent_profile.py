...
from .db_model import JsonModel

from new_sotopia.config import DatabaseArgs
...
class AgentProfile(JsonModel):        
    ...
    def init_profile_store(self):
        args = DatabaseArgs
        self.db = ProfileStore(args=args, database_name="agent_profile")
...
class EnvironmentProfile(JsonModel):   
    ...
    def init_profile_store(self):
        args = DatabaseArgs
        self.db = ProfileStore(args=args, database_name="environment_profile")
...
class RelationshipProfile(JsonModel):    
    ...
    def init_profile_store(self):
        args = DatabaseArgs
        self.db = ProfileStore(args=args, database_name="relationship_profile")
...
class EnvironmentList(JsonModel):    
    ...
    def init_profile_store(self):
        args = DatabaseArgs
        self.db = ProfileStore(args=args, database_name="environment_list")